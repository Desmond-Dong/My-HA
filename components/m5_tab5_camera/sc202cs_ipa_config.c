...
static const uint8_t s_aen_gamma_y[ISP_GAMMA_CURVE_POINTS_NUM] = {
    1, 5, 10, 18, 28, 39, 52, 68, 85, 104, 125, 148, 172, 198, 227, 255,
};
...
static const esp_ipa_aen_gamma_unit_t s_aen_gamma_table_SC202CS[] = {
    {
        .luma = 71.1,
        .gamma = {
            .red   = { .x = { 16, 32, 48, 64, 80, 96, 112, 128, 144, 160, 176, 192, 208, 224, 240, 255 },
                       .y = { 1, 5, 10, 18, 28, 39, 52, 68, 85, 104, 125, 148, 172, 198, 227, 255 } },
            .green = { .x = { 16, 32, 48, 64, 80, 96, 112, 128, 144, 160, 176, 192, 208, 224, 240, 255 },
                       .y = { 1, 5, 10, 18, 28, 39, 52, 68, 85, 104, 125, 148, 172, 198, 227, 255 } },
            .blue  = { .x = { 16, 32, 48, 64, 80, 96, 112, 128, 144, 160, 176, 192, 208, 224, 240, 255 },
                       .y = { 1, 5, 10, 18, 28, 39, 52, 68, 85, 104, 125, 148, 172, 198, 227, 255 } },
        },
    },
};
